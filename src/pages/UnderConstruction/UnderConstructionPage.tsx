          ...
          {isMobile ? (
            <Container>
              ...
              <HoverImageContainer
                ...
                storyDescriptionFirst="Our new normal was abnormality.  The next step was to create something that has never been made before because a masterpiece requires a grand slam. We realized the importance of a standout marketing strategy that would set us apart making a lasting impression."
                nameOfContentClass="hover__image__container__content__two"
                nameOfOverlayClass="hover__image__container__overlay__two"
              />
              <HoverImageContainer
                ...
                storyDescriptionSecond="June 17th 12:48am  Our fears were slowing conquer by a sense of achievement as the moment arrived and we saw the launch of our brand. Phase Zero's debut was an extraordinary success, justifying our efforts and increasing our brand's confidence. A minute’s success pays the failure of years."
                storyDescriptionFirst="Days when results are announced can be stressful, especially if they are unknown. On the day when our clothing line was launching we felt a mix of excitement and fear. What will be the outcome? The  question kept on arising. "
                nameOfContentClass="hover__image__container__content__two"
                nameOfOverlayClass="hover__image__container__overlay__two"
              />
              <HoverImageContainer
              ...
              <HoverImageContainer
                ...
                nameOfHoverClass="hover__image__second"
                storyTitle="#9 - CULT "
                storyDescriptionSecond="Our studio is where everything takes place. Everything means everything when we say it. Sometimes it's our playground, other times it's our private theater, times it's where we party and gaming is everyday sports here. But more than that we talk concepts, visions, and art; helping each other getting a point of view. This is the behind-the-scenes activity that is silently nurturing what you see to be Phase Zero. The weird people there might brainwash you into thinking anything is possible. "
