...
import TransitionsModal from 'pages/UnderConstruction/UnderConstructionModal';
import { UnderBackSS } from 'assets/Images';
...
function Countdown({
  ...
  return (
    <>
      <div style={{ display: isVideoLoading ? 'block' : 'none' }}>
        <LoadingState />
      </div>
      <div
        className="background__video__wrapper"
